...
GET       /$model;format="lower,hyphen"$        controllers.$model;format="UpperCamel"$Controller.show($model;format="lowerCamel"$Id:Int)
POST      /$model;format="lower,hyphen"$        controllers.$model;format="UpperCamel"$Controller.store
PUT       /$model;format="lower,hyphen"$        controllers.$model;format="UpperCamel"$Controller.update($model;format="lowerCamel"$Id:Int)
DELETE    /$model;format="lower,hyphen"$        controllers.$model;format="UpperCamel"$Controller.delete($model;format="lowerCamel"$Id:Int)
*/
