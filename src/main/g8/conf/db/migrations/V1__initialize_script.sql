...
CREATE TRIGGER insert_timestamps BEFORE INSERT ON public.users FOR EACH ROW EXECUTE PROCEDURE public.insert_timestamps();


--
-- Name: user_password_info insert_timestamps; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER insert_timestamps BEFORE INSERT ON public.user_password_info FOR EACH ROW EXECUTE PROCEDURE public.insert_timestamps();


--
-- Name: user_login_info insert_timestamps; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER insert_timestamps BEFORE INSERT ON public.user_login_info FOR EACH ROW EXECUTE PROCEDURE public.insert_timestamps();


--
-- Name: users update_timestamps; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_timestamps BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE PROCEDURE public.update_timestamps();


--
-- Name: user_password_info update_timestamps; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_timestamps BEFORE UPDATE ON public.user_password_info FOR EACH ROW EXECUTE PROCEDURE public.update_timestamps();


--
-- Name: user_login_info update_timestamps; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_timestamps BEFORE UPDATE ON public.user_login_info FOR EACH ROW EXECUTE PROCEDURE public.update_timestamps();
